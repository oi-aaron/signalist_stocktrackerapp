  ...
  return (
    <main className="auth-layout">
        ...
        <section className="auth-right-section">
            ...
            <div className="flex-1 relative"><Image src="/assets/images/dashboard.png" alt="Dashboard Preview" width={1440} height={1150} className="auth-dashboard-preview absolute-top-0"/></div>
        </section>
    </main>
  )
}
